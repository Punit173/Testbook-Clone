    ...
    return (
        <div className='SidebarOptions'>
            ...
            <div className="sidebarOpt effect">
                    <img src="https://qph.cf2.quoracdn.net/main-thumb-t-951-100-N3P1sk6vsq72as9qqwA30zUMvxgBPWJ1.jpeg" alt="" />
                    <p>Mathematics</p>
            </div>
            <div className="sidebarOpt effect">
                    <img src="https://qph.cf2.quoracdn.net/main-thumb-t-897-100-hrukwkbxcneoyfjhaeregbarmrmwxmdx.jpeg" alt="" />
                    <p>Design</p>
            </div>
            <div className="sidebarOpt effect">
                <div className='dot'>
            ...
            <div className="sidebarOpt effect">
                <div className='dot'>
                    <img src="https://qph.cf2.quoracdn.net/main-thumb-t-1913-100-B8JrwaVauFzsaTSqXDqoWLCXzQb2mTE9.jpeg" alt="" />
                </div>
                    <p>Physcology</p>
            </div>
            <div className="sidebarOpt effect">
                <div className='dot'>
                    <img src="https://qph.cf2.quoracdn.net/main-thumb-t-2177-100-JiR07D1TQSfeQzRvWXomVaY4Poj2f8Yb.jpeg" alt="" />
                </div>
                    <p>Technology</p>
            </div>
